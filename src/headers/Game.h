...
void drawWinner(shared_ptr<Client> &client, Texture2D *bgGame, Texture2D *espyciales)
{
    ...
    int backgroundWidth = rectWidth * 3 + 60; // Ancho del fondo considerando el espacio entre los podios
